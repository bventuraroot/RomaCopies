<?php
  // Variables
  return [
    "creatorName" => "Brian Ventura",
    "creatorUrl" => "·",
    "templateName" => "Roma Copies",
    "templateSuffix" => "Administración de Libreria",
    "templateVersion" => "5.0",
    "templateFree" => false,
    "templateDescription" => "Administracion de Libreria",
    "templateKeyword" => "Para empresa de Libreria",
